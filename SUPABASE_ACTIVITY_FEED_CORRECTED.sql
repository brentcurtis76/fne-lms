-- =============================================================================
-- ACTIVITY FEED SYSTEM - PARAMETER CORRECTED VERSION
...
-- Function to create activity (required parameters first, then optional with defaults)
...
-- Function to get activity stats (with default parameter)
CREATE OR REPLACE FUNCTION get_activity_stats(p_workspace_id UUID DEFAULT NULL)
RETURNS JSONB AS $$
DECLARE
    stats JSONB := '{}';
    total_count INTEGER;
