...
const ReadResponseInputSchema = z.object({
  ...
  working_directory: z.string()
    .optional()
    .describe("Working directory for the bridge files (defaults to cwd)")
}).strict();
...
Args:
  - working_directory (string, optional): Directory for bridge files (defaults to current directory)
