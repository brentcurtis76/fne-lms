-- ====================================================================
-- FNE LMS - Add Course Assignment Notification Trigger
-- Fix for teachers receiving wrong notifications when assigned to courses
-- ====================================================================
...
SELECT 
    event_type,
    category,
    notification_template->>'title_template' as title,
    notification_template->>'description_template' as description,
    notification_template->>'url_template' as url
