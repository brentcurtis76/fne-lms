-- ====================================================================
-- FNE LMS: Add "Supervisor de Red" Role System - FIXED VERSION
-- ====================================================================
...
--
-- IMPORTANT: This version splits the enum creation into a separate
-- transaction to avoid PostgreSQL error 55P04
-- ====================================================================

-- ====================================================================
-- PART 1: UPDATE USER ROLE ENUM (Must be in separate transaction)
-- ====================================================================
...
-- NOTE: In Supabase SQL Editor, run up to here first, then run the rest

-- ====================================================================
-- PART 2: CREATE TABLES AND REMAINING SCHEMA (Run after Part 1)
-- ====================================================================
...
-- ====================================================================
-- 4. CREATE AUDIT TRIGGER FOR NETWORKS
-- ====================================================================
...
BEGIN
    IF EXISTS (
        ...
        RAISE NOTICE '✓ supervisor_de_red role type exists';
    ELSE
        RAISE WARNING '✗ supervisor_de_red role type NOT FOUND - Run Part 1 first!';
    END IF;
END
$$;
...
-- 1. Run PART 1 (enum creation) first - up to the comment line
-- 2. Then run PART 2 (everything else) in a separate execution
-- 
-- This two-step process avoids the PostgreSQL error:
