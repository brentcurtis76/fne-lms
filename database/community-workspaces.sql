-- Community Workspaces Database Schema
...
-- Enable RLS on community_workspaces table
...
-- Enable RLS on workspace_activities table
...
-- 8. Create some sample data for testing (optional)
-- This will be handled by the application, but useful for development
