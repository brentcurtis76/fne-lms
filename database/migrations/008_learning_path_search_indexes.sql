...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_roles_school_active 
ON user_roles(school_id, is_active)
WHERE is_active = true;

-- Index for community-based filtering (used when filtering groups by school)
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_roles_community_active 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_cw_community_id 
ON community_workspaces(community_id);

-- Index for name searching
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_cw_name_trgm
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_profiles_first_name_trgm
ON profiles USING gin(first_name gin_trgm_ops);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_profiles_last_name_trgm
