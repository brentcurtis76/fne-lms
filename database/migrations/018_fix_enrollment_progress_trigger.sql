...
-- Date: 2025-10-07
-- Issue: Original trigger referenced is_mandatory column that doesn't exist in blocks table
--
-- This trigger auto-updates course_enrollments.progress_percentage when users
-- complete lesson blocks. The original version failed because it checked
-- blocks.is_mandatory which was never added to the schema.
...
-- Create trigger that fires when lesson progress is completed
...
'Auto-updates course_enrollments progress when lesson blocks are completed. Fixed 2025-10-07 to remove non-existent is_mandatory column dependency.';
