...
| A-8 | Inversión (brochure only) | €1.000 programa + €560 alojamiento (doble) = €1.560; Madrid opcional €810; mín. 5 personas; 50% al acuerdo + saldo 30 días antes. **No fixed validity date** — brochure says "precios vigentes para la cohorte Octubre 2026" (kills the stale-validity failure mode of the old PPTX). | OK (validity resolved by design) |
