...
| A-8 | Inversión (brochure only) | **Programa: €1.000 por persona.** **Alojamiento en Barcelona: variable — entre €70 y €120 por persona por noche, según el tipo de alojamiento** (Brent 2026-07-31; the old fixed "€560 doble / €1.560 total" package is RETIRED — no combined total is quoted anywhere). **No Madrid option** (removed 2026-08-02 — accidental carry from the stale PPTX; may return in a future cohort). Mín. 5 personas; 50% al acuerdo + saldo 30 días antes; "precios vigentes para la cohorte Octubre 2026". Lodging styling (owner-delegated, PM-decided): coordination framing — "se coordina con el equipo FNE según tu preferencia" — veto-able at A3 review. | OK (amended Brent 2026-07-31) |
