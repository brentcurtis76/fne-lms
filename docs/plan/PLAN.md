...
As v2 A3, with evidence location fixed: rendered PNGs of every page at 144 DPI committed to `docs/plan/evidence/a3/` and linked from the report/ledger; PM inspects from the repo, not chat. **Other criteria per amended A-8** (text-extraction tests: brochure carries "1.000" and the lodging band "70"/"120" text, and contains NO "1.560"/"560" total; ficha has no monetary tokens; RFC 5987 filename constants). **Resolve at A3 dispatch, with the owner:** the Madrid €360 lodging figure, and the lodging styling (FNE-managed-at-cost vs self-booked) — both flagged in A-8.
...
| A-8 | Inversión (brochure only) | **Programa: €1.000 por persona.** **Alojamiento en Barcelona: variable — entre €70 y €120 por persona por noche, según el tipo de alojamiento** (Brent 2026-07-31; the old fixed "€560 doble / €1.560 total" package is RETIRED — no combined total is quoted anywhere). Madrid opcional per prior approval (€400 programa + €50 tren; its €360 lodging figure inherits the same doubt — confirm at A3 before the brochure renders it). Mín. 5 personas; 50% al acuerdo + saldo 30 días antes; "precios vigentes para la cohorte Octubre 2026". Open styling question deferred to A3: whether lodging is FNE-managed-at-cost or self-booked (affects brochure copy only, not the data model). | OK (amended Brent 2026-07-31) |
...
| A-16 | Alojamiento octubre — nights + meals mapping | **CLOSED.** Lodging: per-night range per amended A-8 (no night counts quoted — participants compute for their stay). Meals: materials use the generic truthful phrasing "comidas incluidas en los días de visita y cena de cierre" — the exact day mapping is trip-logistics (ops packet), out of comms scope. | OK (Brent 2026-07-31 + PM phrasing) |
...
**El programa (€1.000) incluye:** el pago de las visitas a las escuelas; los talleres de la tarde con especialistas; los honorarios de la dirección del programa, los relatores y el equipo de facilitadores de FNE que acompañan a los pasantes; bibliografía básica recomendada para preparar el viaje, una bitácora y un sistema de registro de los aprendizajes presentado al menos un mes antes del viaje; desayuno a media mañana en las escuelas; transporte para las visitas a El Puig y Les Vinyes; comidas incluidas en los días de visita y cena de cierre.

**Alojamiento (aparte del programa):** en Barcelona, entre €70 y €120 por persona por noche, según el tipo de alojamiento (per amended A-8; no night counts quoted).

**El programa NO incluye:** desayunos de hotel; cenas (salvo la de cierre); pasajes aéreos ni transporte terrestre de llegada/salida; seguros.

**Extensión opcional Madrid:** tres días de visitas — Colegio IDEO, Colegio Santa Gema, Colegio Virgen de Europa (inversión per A-8).
