...
| A8 | Admin leads triage (transition-enforced via API) | **DONE 2026-08-07** (Sol PASS r1 @ `fd33706c`, zero BLOCKING) · **r3 landed `0cb0cf58`**, PM-verified clean 2026-08-08; awaiting a targeted Sol re-check of the r3 diff, then merge | `phase/a8-leads-ui` | A5, T2 |
