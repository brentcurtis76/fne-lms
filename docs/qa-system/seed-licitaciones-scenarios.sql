...
(
  ...
  '[{"index":1,"instruction":"Iniciar sesion como administrador (admin.qa@fne.cl) y navegar a Licitaciones","expectedOutcome":"Se muestra el listado de licitaciones"},{"index":2,"instruction":"Hacer clic en \"Nueva Licitacion\" y seleccionar QA Test School (que tiene encargado asignado). Completar el formulario con los datos requeridos","expectedOutcome":"La licitacion se crea exitosamente y aparece en el listado"},{"index":3,"instruction":"Cerrar sesion del admin. Iniciar sesion como encargado_licitacion (encargado.licitacion.qa@fne.cl / QAtester2026!)","expectedOutcome":"El sistema muestra el panel del encargado"},{"index":4,"instruction":"Verificar el icono de campana en la barra superior y hacer clic sobre el","expectedOutcome":"Se muestra una notificacion con el texto que incluye el numero de la licitacion recien creada y el nombre de la escuela"}]'::jsonb,
  2, 8, true, false, true
),
