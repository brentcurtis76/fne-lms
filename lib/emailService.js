  ...
  async getEmailTemplate(type, notification, user) {
    ...
    return `
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>🔔 Nueva Notificación - FNE LMS</h1>
          </div>
          ...
          <div class="content">
            ...
            <p style="color: #718096; font-size: 14px; margin-top: 30px;">
              ...
              <a href="${preferencesUrl}" style="color: #00365b;">Cambiar preferencias</a>
            </p>
          </div>
    ...
    return `
      ...
      <head>
        ...
        <style>
          ...
          .notification-item:hover { border-left-color: #fdb933; }
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <p style="color: #718096; font-size: 14px; margin-top: 30px; text-align: center;">
              <a href="${preferencesUrl}" style="color: #00365b;">Cambiar preferencias de notificación</a>
            </p>
          </div>
