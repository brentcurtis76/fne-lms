...
export const communityWorkspaceService = {
  ...
  async canEditWorkspace(userId, workspaceId) {
    try {
      ...
      // Check if user is a member of this community (any role)
      ...
      // User can edit if they are admin OR any member of this community
      const canEdit = roles.some(role => 
        role.role_type === 'admin' || 
        role.community_id === workspace.community_id
      );
