...
export default function NewLearningPath() {
  ...
  const checkAuthAndLoadCourses = async () => {
    try {
      ...
      if (!hasAccess) {
        toast.error('No tienes permisos para crear rutas de aprendizaje');
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    const loadingToast = toast.loading('Creando ruta de aprendizaje...');
    ...
    try {
      ...
      toast.success('Ruta de aprendizaje creada exitosamente', { id: loadingToast });
      router.push('/admin/learning-paths');
      
    } catch (error: any) {
      console.error('Error creating learning path:', error);
      toast.error(error.message || 'Error al crear la ruta de aprendizaje', { id: loadingToast });
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <MainLayout
      ...
      pageTitle="Crear Ruta de Aprendizaje"
      breadcrumbs={[
    ...
    >
      <Head>
        <title>Crear Ruta de Aprendizaje</title>
      </Head>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">
            Define una secuencia de cursos para guiar el aprendizaje de los estudiantes
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            {/* Selected Courses */}
            <div>
              <h3 className="text-lg font-medium leading-6 text-gray-900">Cursos Seleccionados</h3>
              <p className="mt-1 text-sm text-gray-500">Arrastra para reordenar los cursos.</p>
            </div>
            <div className="mt-4">
                          ...
                          >
                            {(provided, snapshot) => (
                              <div
                                ...
                                className={`p-3 bg-white border rounded-lg flex items-center shadow-sm ${
