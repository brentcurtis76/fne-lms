  ...
  return (
    <div className="space-y-2">
      <textarea
        ...
        className="w-full resize-y rounded-lg border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 shadow-sm placeholder:italic placeholder:text-slate-400 transition-shadow focus:outline-none focus-visible:border-amber-300 focus-visible:ring-2 focus-visible:ring-amber-400/40"
        rows={4}
        disabled={disabled}
      />
