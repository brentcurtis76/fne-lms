    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-[#0a0a0a] text-white">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <h1 className="text-3xl font-bold">📧 Genera Email Showcase</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h2 className="text-xl font-bold text-[#0a0a0a] mb-4">Email Templates ({templates.length})</h2>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 bg-white rounded-lg shadow-lg p-6">
              <h4 className="font-semibold text-[#0a0a0a] mb-3">Template Details</h4>
        ...
        <div className="mt-12 bg-white rounded-lg shadow-lg p-8">
          <h2 className="text-2xl font-bold text-[#0a0a0a] mb-6">🚀 Email System Features</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="w-12 h-12 bg-[#fbbf24] rounded-full flex items-center justify-center mx-auto mb-3">
                <span className="text-[#0a0a0a] font-bold text-xl">📱</span>
              </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Professional design with Navy Blue (#0a0a0a) and Golden Yellow (#fbbf24).</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-[#fbbf24] rounded-full flex items-center justify-center mx-auto mb-3">
                <span className="text-[#0a0a0a] font-bold text-xl">⚡</span>
            ...
            <div className="text-center">
              <div className="w-12 h-12 bg-[#fbbf24] rounded-full flex items-center justify-center mx-auto mb-3">
                <span className="text-[#0a0a0a] font-bold text-xl">🛡️</span>
              </div>
