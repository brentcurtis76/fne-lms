...
async function fixDirectivosPdfUrl() {
  console.log('Fixing Programa Estratégico para Directivos PDF URL...\n');

  const correctUrl = 'https://heyzine.com/flip-book/92bf9eb5ee.html';
  const programName = 'Programa Estratégico para Directivos';
