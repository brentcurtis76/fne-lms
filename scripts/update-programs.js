    ...
    const programs = [
      {
        ...
        description: 'Pasantía internacional para líderes educativos con visitas a escuelas innovadoras, talleres especializados y certificación internacional. Precio regular: $2.500.000 CLP. Precio especial: $2.000.000 CLP si se paga antes del 31 de marzo de 2026.',
        price: 2500000,
        pdf_url: 'https://heyzine.com/flip-book/fb8cf2cfb1.html',
        display_order: 1,
        is_active: true
      },
      {
        name: 'Programa Estratégico para Directivos',
        description: 'Experiencia intensiva de liderazgo educativo y gestión del cambio para equipos directivos. Precio regular: $2.500.000 CLP. Precio especial: $2.000.000 CLP si se paga antes del 31 de marzo de 2026.',
        price: 2500000,
        pdf_url: 'https://heyzine.com/flip-book/92bf9eb5ee.html',
        display_order: 2,
        is_active: true
      }
    ];
