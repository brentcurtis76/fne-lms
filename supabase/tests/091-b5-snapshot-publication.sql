...
SELECT policies_are('public', 'assessment_template_source_revisions',
  ARRAY['assessment_template_source_revisions_admin_select', 'forced_password_change_guard']::name[],
  'only the admin select policy and the forced password change guard exist');
