...
SELECT cmp_ok(pg_temp.d('casc', 'D'), '>=', 1::BIGINT, 'objective cascade advances objective parent D');
SELECT cmp_ok(pg_temp.d('casc', 'E'), '>=', 1::BIGINT, 'cascaded module with direct template E advances E');
...
SELECT cmp_ok(pg_temp.d('tdel', 'E'), '>=', 1::BIGINT, 'surviving template E of cross-template cascaded module advances');
